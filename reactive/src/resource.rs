use std::{cell::RefCell, future::Future, rc::Rc, collections::HashSet};

use crate::{ReadSignal, RwSignal, WriteSignal, batch, Memo, create_memo};
...
pub struct SuspenseContext {
    ...
    pub(crate) pending: RwSignal<HashSet<ResourceId>>,
    pub(crate) pending_serializable_resources: RwSignal<HashSet<ResourceId>>,
