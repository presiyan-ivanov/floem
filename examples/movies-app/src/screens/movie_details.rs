...
use floem::{
    ...
    views::{
        ...
        static_label, svg, tab, text, v_stack, virtual_stack, Decorators, Label, VirtualDirection, VirtualItemSize, virtual_list,
    },
};
...
use crate::{
    ...
    spinner::spinner,
    ActiveTabKind, GlobalState, MainTab, MovieDetailsState, SubTab, NAVBAR_BG_COLOR,
